...
//    private var systemClassInLoadingOrder = Classes()
    ...
    public func addSystemClass(_ aClass: Type)
        ...
        (aClass as! TypeClass)._isSystemType = true
    ...
    private func initTypes()
        ...
        self.addSystemClass(TypeRootClass().mcode("o").setType(.object))
        self.addSystemClass(TypeValueClass(label: "Magnitude").superclass(self.object).setType(.magnitude))
        self.addSystemClass(TypeValueClass(label: "Number").superclass(self.magnitude).setType(.number))
        self.addSystemClass(TypePrimitiveClass(label: "Integer").superclass(self.number).setType(.integer))
        self.addSystemClass(TypePrimitiveClass(label: "UInteger").superclass(self.number).mcode("u").setType(.uInteger))
        self.addSystemClass(TypePrimitiveClass(label: "Boolean").superclass(self.object).setType(.boolean))
        self.addSystemClass(TypeClass(label: "String").superclass(self.object).setType(.string))
        self.addSystemClass(TypeClass(label: "Slot").superclass(self.object).mcode("l").setType(.slot))
        self.addSystemClass(TypeClass(label:"Iterable").superclass(self.object).mcode("d"))
        self.addSystemClass(TypeClass(label: "Collection").superclass(self.object).mcode("f").setType(.collection))
        self.addSystemClass(TypeArrayClass(label:"Array").superclass(self.collection).mcode("a").setType(.array))
        self.addSystemClass(TypeClass(label: "Type").superclass(self.object).setType(.type))
        self.addSystemClass(TypeClass(label: "Class").superclass(self.typeClass).mcode("c").setType(.class))
        self.addSystemClass(TypeClass(label: "Error").superclass(self.object).setType(.error))
        self.addSystemClass(TypeClass(label: "Block").superclass(self.object).setType(.block))
        self.addSystemClass(TypeClass(label: "Index").superclass(self.object).setType(.index))
        self.addSystemClass(TypePrimitiveClass(label: "Float").superclass(self.number).mcode("f").setType(.float))
        self.addSystemClass(TypeClass(label: "Void").superclass(self.object).mcode("v").setType(.void))
        self.addSystemClass(TypePrimitiveClass(label: "Character").superclass(self.magnitude).mcode("c").setType(.character))
        self.addSystemClass(TypePrimitiveClass(label: "Time").superclass(self.magnitude).mcode("t").setType(.time))
        self.addSystemClass(TypePrimitiveClass(label: "Date").superclass(self.magnitude).mcode("d").setType(.date))
        self.addSystemClass(TypePrimitiveClass(label: "DateTime").superclass(self.date).superclass(self.time).mcode("z").setType(.dateTime))
        self.addSystemClass(TypeClass(label: "Address").superclass(self.uInteger).mcode("h").setType(.address))
        self.addSystemClass(TypeClass(label: "Symbol").superclass(self.string).mcode("x").setType(.symbol))
        self.addSystemClass(TypePrimitiveClass(label: "Byte").superclass(self.magnitude).mcode("b").setType(.byte))
        self.addSystemClass(TypeClass(label: "Enumeration").superclass(self.typeClass).mcode("e").setType(.enumeration))
        self.addSystemClass(TypeClass(label: "EnumerationCase").superclass(self.object).mcode("q").setType(.enumerationCase))
        self.addSystemClass(TypeClass(label: "Tuple").superclass(self.typeClass).mcode("p").setType(.tuple))
        self.addSystemClass(TypeClass(label: "Module").superclass(self.typeClass).setType(.module))
        self.addSystemClass(TypeClass(label: "Parameter").superclass(self.slot).setType(.parameter))
        self.addSystemClass(TypeClass(label: "Nil").superclass(self.object).mcode("a").setType(.nil))
        self.addSystemClass(TypeClass(label: "Invokable").superclass(self.object).setType(.invokable))
        self.addSystemClass(TypeClass(label: "Function").superclass(self.invokable).mcode("f").setType(.function))
        self.addSystemClass(TypeClass(label: "MethodInstance").superclass(self.invokable).setType(.methodInstance))
        self.addSystemClass(TypeClass(label: "Instruction").superclass(self.object).setType(.instruction))
        self.addSystemClass(TypeClass(label: "DictionaryBucket").superclass(self.object).setType(.dictionaryBucket))
        self.addSystemClass(TypeClass(label: "Dictionary").superclass(self.collection).mcode("j").setType(.dictionary))
        self.addSystemClass(TypeClass(label: "List").superclass(self.collection).mcode("n").setType(.list))
        self.addSystemClass(TypeClass(label: "ListNode").superclass(self.collection).mcode("N").setType(.listNode))
        self.addSystemClass(TypeClass(label: "Pointer").superclass(self.object).mcode("P").setType(.pointer))
        self.addSystemClass(TypeClass(label: "Set").superclass(self.collection).mcode("S").setType(.set))
        self.addSystemClass(TypeArrayClass(label: "Vector").superclass(self.collection).mcode("V").setType(.vector))
        self.addSystemClass(TypeClass(label: "Closure").superclass(self.invokable).mcode("C").setType(.closure))
        self.addSystemClass(TypeClass(label: "Metatype").superclass(self.typeClass).mcode("t").setType(.metaclass))
        self.addSystemEnumeration(TypeEnumeration(label: "Opcode").cases("#CALL","#CALLP","#STP","#LFP","#IADD","#FADD","#ISUB","#FSUB","#IMUL","#FMUL","#IDIV","#FDIV","#IMOD","#FMOD","#IPOW","#FPOW","#ILT","#ILTEQ","#IEQ","#INEQ","#IGT","#IGTEQ","#FLT","FLTEQ","#FEQ","#FNEQ","#FGT","#FGTEQ","#INEG","#FNEG","#IBITAND","#IBITOR","#IBITXOR","#NOT","#BITNOT","#IINC","#IDEC","#IINCW","#IDECW","#RET","#PUSH","#POP","#MOV"))
        self.addSystemEnumeration(TypeEnumeration(label: "Literal").case("#integer",[self.integer]).case("float",[self.float]).case("boolean",[self.boolean]).case("byte",[self.byte]).case("character",[self.character]).case("string",[self.string]).case("address",[self.address]))
        self.addSystemEnumeration(TypeEnumeration(label: "Operand").case("#literal",[self.literal]).case("#address",[self.address]).case("#indirect",[self.integer,self.integer]).case("#return",[]).case("#stack",[]).case("#frame",[]).case("#label",[self.integer]).case("#temporary",[self.integer]).case("#literal",[self.literal]).case("#none",[]))
        self.addSystemEnumeration(TypeEnumeration(label: "SlotType").cases("#instanceSlot","#localSlot","#moduleSlot","#classSlot","#magicNumberSlot","#headerSlot","#virtualReadSlot","#virtualReadWriteSlot","#cocoonSlot"))
