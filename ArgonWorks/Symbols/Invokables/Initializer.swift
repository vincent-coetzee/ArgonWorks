...
//        didSet
//            {
//            self.type = Argon.addType(TypeFunction(label: self.label,types: self.parameters.map{$0.type!},returnType: self.declaringType))
//            }
//        }
...
//        self.type = Argon.addType(TypeFunction(label: self.label,types: self.parameters.map{$0.type!.freshTypeVariable(inContext: context)},returnType: self.declaringType))
//        }
//        
