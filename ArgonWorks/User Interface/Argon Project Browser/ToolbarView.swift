...
public class ToolbarView: CustomView
    {
    public override func awakeFromNib()
        ...
        self.addTextLabel(atEdge: .left, key: "issues", valueModel: ValueHolder(value: "0 issues"), textColor: NSColor.argonLightGray, borderColor: NSColor.argonDarkerGray, borderWidth: 1, cornerRadius: 3, backgroundColor: .argonDarkerGray)
        ...
        self.addActionButton(atEdge: .right,key: "add",image: NSImage(named: "IconAdd")!,toolTip: "Add New Record",target: self,action: #selector(self.someAction))
        ...
        self.addActionButton(atEdge: .right,key: "module",image: NSImage(named: "IconModule")!,toolTip: "New Module Record",target: self,action: #selector(self.someAction))
        self.addActionButton(atEdge: .right,key: "comment",image: NSImage(named: "IconFile")!,toolTip: "New Comment Record",target: self,action: #selector(self.someAction))
        self.addActionButton(atEdge: .right,key: "slot",image: NSImage(named: "IconSlot")!,toolTip: "New Module Slot Record",target: self,action: #selector(self.someAction))
