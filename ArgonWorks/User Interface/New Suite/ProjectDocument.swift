...
extension UTType
    ...
    static var argonVelocityFile: UTType
        {
        UTType(exportedAs: "com.macsemantics.argon.velocity")
        }
        
    static var argonObjectFile: UTType
        {
        UTType(exportedAs: "com.macsemantics.argon.object")
        }
    }
