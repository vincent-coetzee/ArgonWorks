...
//    
//    private var registerFields = Array<NSTextField>(repeating: NSTextField(), count: 0)
//    private var registerValueFields = Array<NSTextField>(repeating: NSTextField(), count:0)
//    private var lastValues = Array<Word>(repeating: 0,count: 0)
