...
//        case LCON = 22  // LOAD CONSTANT IN OPERAND1 INTO OPERAND3
        case CAST = 23  // CAST OBJECT IN ADDRESS1 TO CLASS ADDRESS2 AND PUT THE RESULT INTO OPERAND3
        case LOADP = 24 // LOAD [ADDRESS1 + INTEGER2] INTO OPERAND3
        case STOREP = 25// STORE OPERAND1 IN [ADDRESS2 + INTEGER3]
        case MOVE = 26 // MOVE VALUE IN OPERAND1 INTO OPERAND2
        case BRT = 27
        case BRF = 28
        case BR = 29
        case SAVE = 30
    ...
    public enum Operand
        ...
        public static let kTagShift:Word = 57
        public static let kTagMask:Word = 0b111 << Operand.kTagShift
